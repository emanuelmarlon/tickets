              ...
              return Column(
                ...
                children: [
                  ...
                  MouseRegion(
                    ...
                    onEnter: ((event) async {
                      setState(() => _model.mrcriarticketHovered = true);
                    }),
                    onExit: ((event) async {
                      setState(() => _model.mrcriarticketHovered = false);
                    }),
                    child: Padding(
                      padding:
                  ...
                  MouseRegion(
                    ...
                    cursor: MouseCursor.defer ?? MouseCursor.defer,
                    onEnter: ((event) async {
                      setState(() => _model.mratividadeHovered = true);
                    }),
                    onExit: ((event) async {
                      setState(() => _model.mratividadeHovered = false);
                    }),
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(16.0, 8.0, 16.0, 0.0),
