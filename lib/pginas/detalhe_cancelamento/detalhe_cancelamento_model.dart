...
import 'dart:async';
import 'detalhe_cancelamento_widget.dart' show DetalheCancelamentoWidget;
import 'package:flutter/material.dart';

class DetalheCancelamentoModel
    extends FlutterFlowModel<DetalheCancelamentoWidget> {
  ...
  List<PedidosYampiV2Row>? pedidoId;
  Completer<List<UserTtRow>>? requestCompleter3;
  // Stores action output result for [Backend Call - Query Rows] action in Button widget.
  List<PedidosYampiV2Row>? pedidoId2;
  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
