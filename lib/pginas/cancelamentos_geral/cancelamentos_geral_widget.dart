...
import 'cancelamentos_geral_model.dart';
export 'cancelamentos_geral_model.dart';

class CancelamentosGeralWidget extends StatefulWidget {
  const CancelamentosGeralWidget({super.key});

  @override
  State<CancelamentosGeralWidget> createState() =>
      _CancelamentosGeralWidgetState();
}

class _CancelamentosGeralWidgetState extends State<CancelamentosGeralWidget>
    with TickerProviderStateMixin {
  late CancelamentosGeralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CancelamentosGeralModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SuporteTRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SuporteTRow> cancelamentosGeralSuporteTRowList = snapshot.data!;

        return Title(
            title: 'cancelamentosGeral',
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Builder(
                                                                              builder: (context) {
                                                                                final tickets = cancelamentosGeralSuporteTRowList.toList();
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Builder(
                                                                              builder: (context) {
                                                                                final tickets = cancelamentosGeralSuporteTRowList.where((e) => e.status == _model.status).toList();
