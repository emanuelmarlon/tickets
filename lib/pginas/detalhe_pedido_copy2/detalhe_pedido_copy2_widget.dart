...
import 'detalhe_pedido_copy2_model.dart';
export 'detalhe_pedido_copy2_model.dart';

class DetalhePedidoCopy2Widget extends StatefulWidget {
  const DetalhePedidoCopy2Widget({
    super.key,
    this.id,
  });
  ...
  @override
  State<DetalhePedidoCopy2Widget> createState() =>
      _DetalhePedidoCopy2WidgetState();
}

class _DetalhePedidoCopy2WidgetState extends State<DetalhePedidoCopy2Widget>
    with TickerProviderStateMixin {
  late DetalhePedidoCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhePedidoCopy2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhePedidoCopy2PedidoYampiResponse = snapshot.data!;

        return Title(
            title: 'detalhePedidoCopy2',
                                  ...
                                  child: Padding(
                                    ...
                                    child: EstornarWidget(
                                      numeroPedido: PedidoYampiCall.orderyampi(
                                        detalhePedidoCopy2PedidoYampiResponse
                                            .jsonBody,
                                      )?.toString(),
