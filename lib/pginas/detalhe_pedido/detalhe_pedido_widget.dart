...
import 'detalhe_pedido_model.dart';
export 'detalhe_pedido_model.dart';

class DetalhePedidoWidget extends StatefulWidget {
  const DetalhePedidoWidget({
    super.key,
    this.id,
  });
  ...
  @override
  State<DetalhePedidoWidget> createState() => _DetalhePedidoWidgetState();
}

class _DetalhePedidoWidgetState extends State<DetalhePedidoWidget>
    with TickerProviderStateMixin {
  late DetalhePedidoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhePedidoModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhePedidoPedidoYampiResponse = snapshot.data!;
                            ...
                            confirmDialogResponse = await showDialog<bool>(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text('CRM Byana'),
                                      content: const Text(
                                          'Esta função ainda está em desenvolvimento. Em breve, teremos novidades! Obrigado pela paciência.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () => Navigator.pop(
                                              alertDialogContext, false),
                                  ...
                                  child: Padding(
                                    ...
                                    child: EstornarWidget(
                                      numeroPedido: PedidoYampiCall.orderyampi(
                                        detalhePedidoPedidoYampiResponse
                                            .jsonBody,
                                      )?.toString(),
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: Image
                                                                        ...
                                                                        valueOrDefault<
                                                                          ...
                                                                          PedidoYampiCall
                                                                              .imagemPagamento(
                                                                            detalhePedidoPedidoYampiResponse.jsonBody,
                                                                          ),
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        ListarTransacoesCall
                                                                            .parcelas(
                                                                          (_model.transacoesYampi?.jsonBody ??
                                                                              ''),
                                                                        ),
                                                                        'Não informado',
                                                                      ),
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: FutureBuilder<ApiCallResponse>(
                                      future: ListarProdutosDeUmPedidoYampiCall
                                          .call(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final tabBarListarProdutosDeUmPedidoYampiResponse =
                                            snapshot.data!;
                                                                              ...
                                                                              Expanded(
                                                                                child: Stack(
                                                                                  children: [
                                                                                    ...
                                                                                    Align(
                                                                                      alignment: const AlignmentDirectional(-0.47, 0.0),
                                                                                      child: Text(
                                                                                        ' Pagamento aprovado',
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Plus Jakarta Sans',
                                                                                    ...
                                                                                    Align(
                                                                                      alignment: const AlignmentDirectional(-0.16, 0.0),
                                                                                      child: Text(
                                                                                        'Faturado',
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Plus Jakarta Sans',
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              badges.Badge(
                                                                                badgeContent: Text(
                                                                                  valueOrDefault<String>(
                                                                                    ListarProdutosDeUmPedidoYampiCall.data(
                                                                                      tabBarListarProdutosDeUmPedidoYampiResponse.jsonBody,
                                                                                    )?.length.toString(),
                                                                                    '0',
                                                                                  ),
                                                                                ...
                                                                                badgeColor: const Color(0xFF582DB4),
                                                                                elevation: 4.0,
                                                                                            ...
                                                                                            child: Material(
                                                                                              ...
                                                                                              child: Container(
                                                                                                ...
                                                                                                child: Column(
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Padding(
                                                                                                      padding: const EdgeInsetsDirectional.fromSTEB(12.0, 12.0, 12.0, 6.0),
                                                                                                      child: Row(
                                                                                                        mainAxisSize: MainAxisSize.max,
                                                                                                        mainAxisAlignment: MainAxisAlignment.center,
                                                                                                        crossAxisAlignment: CrossAxisAlignment.center,
                                                  ...
                                                  KeepAliveWidgetWrapper(
                                                    builder: (context) =>
                                                      ...
                                                      builder:
                                                        ...
                                                        final containerListarNotaFiscalDeUmPedidoResponse =
                                                            snapshot.data!;
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  valueOrDefault<String>(
                                                                                    ListarNotaFiscalDeUmPedidoCall.numero(
                                                                                      containerListarNotaFiscalDeUmPedidoResponse.jsonBody,
                                                                                    ),
                                                                                    '0',
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Builder(
                                                                  builder:
                                                                      (context) {
                                                                    final listaStatus =
                                                                        ListarHistoricoDeStatusDeUmPedidoYampyCall.data(
