...
import 'tickets_geral_model.dart';
export 'tickets_geral_model.dart';

class TicketsGeralWidget extends StatefulWidget {
  const TicketsGeralWidget({super.key});

  @override
  State<TicketsGeralWidget> createState() => _TicketsGeralWidgetState();
}

class _TicketsGeralWidgetState extends State<TicketsGeralWidget>
    with TickerProviderStateMixin {
  late TicketsGeralModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TicketsGeralModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SuporteTRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SuporteTRow> ticketsGeralSuporteTRowList = snapshot.data!;
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Builder(
                                                                              builder: (context) {
                                                                                final tickets = ticketsGeralSuporteTRowList.toList();
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Builder(
                                                                              builder: (context) {
                                                                                final tickets = ticketsGeralSuporteTRowList.where((e) => e.status == _model.status).toList();
