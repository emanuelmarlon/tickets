...
class ColumnchartFunil extends StatefulWidget {
  const ColumnchartFunil({
    Key? key,
    this.width,
    this.height,
  ...
  @override
  State<ColumnchartFunil> createState() => _ColumnchartFunilState();
}

class _ColumnchartFunilState extends State<ColumnchartFunil> {
