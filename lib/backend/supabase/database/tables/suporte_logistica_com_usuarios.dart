...
class SuporteLogisticaComUsuariosTable
    extends SupabaseTable<SuporteLogisticaComUsuariosRow> {
  @override
  String get tableName => 'suporte_logistica_com_usuarios';

  @override
  SuporteLogisticaComUsuariosRow createRow(Map<String, dynamic> data) =>
      SuporteLogisticaComUsuariosRow(data);
}

class SuporteLogisticaComUsuariosRow extends SupabaseDataRow {
  SuporteLogisticaComUsuariosRow(super.data);

  @override
  SupabaseTable get table => SuporteLogisticaComUsuariosTable();
