...
import 'adicionar_comentario_model.dart';
export 'adicionar_comentario_model.dart';

class AdicionarComentarioWidget extends StatefulWidget {
  const AdicionarComentarioWidget({
    super.key,
    required this.comentTicket,
  });

  final SuporteTRow? comentTicket;

  @override
  State<AdicionarComentarioWidget> createState() =>
      _AdicionarComentarioWidgetState();
}

class _AdicionarComentarioWidgetState extends State<AdicionarComentarioWidget> {
  late AdicionarComentarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdicionarComentarioModel());
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            await geminiGenerateText(
                                              context,
                                              'Melhore a escrita abaixo\"${_model.textController.text}\"',
                                            ).then((generatedText) {
                                              safeSetState(() =>
