...
import 'alterar_comentario_logistica_model.dart';
export 'alterar_comentario_logistica_model.dart';

class AlterarComentarioLogisticaWidget extends StatefulWidget {
  const AlterarComentarioLogisticaWidget({
    super.key,
    required this.comentario,
  });

  final ComentariosTicketsLogisticaRow? comentario;

  @override
  State<AlterarComentarioLogisticaWidget> createState() =>
      _AlterarComentarioLogisticaWidgetState();
}

class _AlterarComentarioLogisticaWidgetState
    extends State<AlterarComentarioLogisticaWidget> {
  late AlterarComentarioLogisticaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlterarComentarioLogisticaModel());
