  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SuporteTRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SuporteTRow> ticketsSuporteTRowList = snapshot.data!;
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Text(
                                                                          'Aberto - ${valueOrDefault<String>(
                                                                            ticketsSuporteTRowList.where((e) => e.status == 'Aberto').toList().length.toString(),
                                                                            '0',
                                                                          )}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final tickets =
                                                                                ticketsSuporteTRowList.where((e) => e.status == 'Aberto').toList();
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Text(
                                                                          'Em andamento - ${valueOrDefault<String>(
                                                                            ticketsSuporteTRowList.where((e) => e.status == 'Em andamento').toList().length.toString(),
                                                                            '0',
                                                                          )}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final tickets2 =
                                                                                ticketsSuporteTRowList.where((e) => e.status == 'Em andamento').toList();
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Text(
                                                                          'Pendente - ${valueOrDefault<String>(
                                                                            ticketsSuporteTRowList.where((e) => e.status == 'Pendente').toList().length.toString(),
                                                                            '0',
                                                                          )}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final tickets3 =
                                                                                ticketsSuporteTRowList.where((e) => e.status == 'Pendente').toList();
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              final tickets = ticketsSuporteTRowList.where((e) => e.status == 'Aberto').toList();
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                                Builder(
                                                                              builder: (context) {
                                                                                final tickets2 = ticketsSuporteTRowList.where((e) => e.status == 'Em andamento').toList();
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              final tickets3 = ticketsSuporteTRowList.where((e) => e.status == 'Pendente').toList();
