                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                          (context) {
                                                                        final telefone = functions
                                                                            .retiraDuplicados(FFAppState().pedido.map((e) => e.phone).toList())
                                                                            .toList();
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                          (context) {
                                                                        final email = functions
                                                                            .retiraDuplicados(FFAppState().pedido.map((e) => e.email).toList())
                                                                            .toList();
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        formatNumber(
                                                                          functions.somarDoubleFiltro(FFAppState()
                                                                              .pedido
                                                                              .toList()),
                                                                          formatType:
                                                                              FormatType.decimal,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        functions.tempoSemComprar(functions.formatDate(FFAppState()
                                                                            .pedido
                                                                            .first
                                                                            .createdAt)),
                                                                        'Data',
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              Column(
                                                                                                ...
                                                                                                children: [
                                                                                                  ...
                                                                                                  FFButtonWidget(
                                                                                                    onPressed: (pedidosItem.estorno == true)
                                                                                                        ? null
                                                                                                        : () async {
