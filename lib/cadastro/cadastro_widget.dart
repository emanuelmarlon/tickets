                                ...
                                children: [
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.nomeCompeltoTextController,
                                        focusNode: _model.nomeCompeltoFocusNode,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.senhaCadastroConfirmarFocusNode,
                                    obscureText: !_model
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.emailCadastroTextController
                                          ...
                                          if (_model.nomeCompeltoTextController
                                                  .text ==
                                              '') {
                                            await showDialog(
                                              context: context,
                                        ...
                                        if (_model.senhaCadastroTextController
                                                .text !=
                                            _model
                                                .senhaCadastroConfirmarTextController
                                                .text) {
                                        ...
                                        _model.usuario =
                                          ...
                                          'email': _model
                                              .emailCadastroTextController.text,
                                          'nome': _model
                                              .nomeCompeltoTextController.text,
                                          'transportadora': _model.switchValue,
                                        });
                                        shouldSetState = true;
